...
Page({
  data: { reportType: 'user', loading: false, busy: false, error: '', reportUrl: '', generatedAt: '', total: null, condition: '', startDate: '', endDate: '', statusIndex: 0, statuses: ['全部状态', '待接单', '已接单', '已取件', '待收货', '异常中', '已完成', '已取消'] },
