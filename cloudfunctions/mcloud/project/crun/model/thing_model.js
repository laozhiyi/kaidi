...
ThingModel.DB_STRUCTURE = {
	...
	// ========== 接单人确认完成相关字段 ==========
	THING_PICKUP_PIC: 'array|false|default=[]|comment=接单人取件照片',
	THING_DELIVER_PIC: 'array|false|default=[]|comment=接单人接收照片',
	THING_OVER_DESC: 'string|false|comment=接单人补充说明',
	THING_OVER_DESC_PIC: 'array|false|default=[]|comment=接单人补充说明照片',
	THING_OVER_USER_ID: 'string|false|comment=确认完成的接单人ID',
